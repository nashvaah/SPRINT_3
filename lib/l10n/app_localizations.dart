...
abstract class AppLocalizations {
  ...
  /// No description provided for @volunteerService.
  ///
  /// In en, this message translates to:
  /// **'Volunteer Service'**
  String get volunteerService;

  /// No description provided for @caretakerService.
  ///
  /// In en, this message translates to:
  /// **'Caretaker Service'**
  String get caretakerService;
  ...
  /// No description provided for @medicinePickup.
  ///
  /// In en, this message translates to:
  /// **'Medicine pickup'**
  String get medicinePickup;
  ...
  /// No description provided for @dailyErrands.
  ///
  /// In en, this message translates to:
  /// **'Daily errands'**
  String get dailyErrands;

  /// No description provided for @commonMedicines.
  ///
  /// In en, this message translates to:
  /// **'Common Medicines (Select needed):'**
  String get commonMedicines;

  /// No description provided for @medicineDetailsHint.
  ///
  /// In en, this message translates to:
  /// **'Exact Medicine Names / Dosage / Prescription Info'**
  String get medicineDetailsHint;

  /// No description provided for @medicineExampleHint.
  ///
  /// In en, this message translates to:
  /// **'e.g., Dolo 650 1 strip, Amlodipine 5mg...'**
  String get medicineExampleHint;

  /// No description provided for @commonItems.
  ///
  /// In en, this message translates to:
  /// **'Common Items (Select needed):'**
  String get commonItems;

  /// No description provided for @specificItemsHint.
  ///
  /// In en, this message translates to:
  /// **'Specific Items & Quantities'**
  String get specificItemsHint;

  /// No description provided for @itemExampleHint.
  ///
  /// In en, this message translates to:
  /// **'e.g., 2 liters Milk, 1 loaf of wheat bread...'**
  String get itemExampleHint;
  ...
  /// No description provided for @capturingGps.
  ///
  /// In en, this message translates to:
  /// **'Capturing GPS coordinates...'**
  String get capturingGps;

  /// No description provided for @locationAutoCapture.
  ///
  /// In en, this message translates to:
  /// **'Location is captured automatically using live GPS.'**
  String get locationAutoCapture;

  /// No description provided for @retryAccess.
  ///
  /// In en, this message translates to:
  /// **'Retry Access'**
  String get retryAccess;
  ...
  ///
  /// In en, this message translates to:
  /// **'e.g. Need medicine from ABC clinic'**
  ...
  /// No description provided for @enableLocationToContinue.
  ///
  /// In en, this message translates to:
  /// **'Please enable location access to continue.'**
  String get enableLocationToContinue;

  /// No description provided for @requestVolunteer.
  ///
  /// In en, this message translates to:
  /// **'Request Volunteer'**
  String get requestVolunteer;

  /// No description provided for @availableNearbyVolunteers.
  ///
  /// In en, this message translates to:
  /// **'Available Nearby Volunteers'**
  String get availableNearbyVolunteers;

  /// No description provided for @availableNearbyCaregivers.
  ///
  /// In en, this message translates to:
  /// **'Available Nearby Caregivers'**
  String get availableNearbyCaregivers;
  ...
  /// No description provided for @volunteerLabel.
  ///
  /// In en, this message translates to:
  /// **'Volunteer:'**
  String get volunteerLabel;

  /// No description provided for @caretakerLabel.
  ///
  /// In en, this message translates to:
  /// **'Caretaker:'**
  ...
  /// No description provided for @reasonLabelDetailed.
  ///
  /// In en, this message translates to:
  /// **'Reason:'**
  String get reasonLabelDetailed;
  ...
  /// No description provided for @bookProfessionalCaretaker.
  ///
  /// In en, this message translates to:
  /// **'Book Professional Caretaker'**
  String get bookProfessionalCaretaker;
  ...
  /// No description provided for @bookCaretaker.
  ///
  /// In en, this message translates to:
  /// **'Book Caretaker'**
  String get bookCaretaker;

  /// No description provided for @allowHealthAccess.
  ///
  /// In en, this message translates to:
  /// **'Allow Health Monitor Access'**
  String get allowHealthAccess;

  /// No description provided for @healthAccessDesc.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Caretaker booking requested!'**
  String get bookingRequestedSuccess;

  /// No description provided for @noVolunteersNearby.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @servicesHeader.
  ///
  /// In en, this message translates to:
  /// **'Services'**
  String get servicesHeader;

  /// No description provided for @volunteerServiceDesc.
  ///
  /// In en, this message translates to:
  /// **'Request help for medicine pickup, daily errands, and basic support.'**
  String get volunteerServiceDesc;

  /// No description provided for @caretakerServiceDesc.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @commonMedicinesSelect.
  ///
  /// In en, this message translates to:
  /// **'Common Medicines (Select needed)'**
  String get commonMedicinesSelect;

  /// No description provided for @medicineNamesDosagePrescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @volunteerOnTheWay.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @medicalOverview.
  ///
  /// In en, this message translates to:
  /// **'Medical Overview'**
  String get medicalOverview;
  ...
  /// No description provided for @documentsReports.
  ///
  /// In en, this message translates to:
  /// **'Documents & Reports'**
  String get documentsReports;

  /// No description provided for @viewUploadMedicalRecords.
  ///
  /// In en, this message translates to:
  /// **'View & Upload Medical Records'**
  String get viewUploadMedicalRecords;
  ...
  /// No description provided for @storedVitals.
  ///
  /// In en, this message translates to:
  /// **'Stored Vitals'**
  String get storedVitals;

  /// No description provided for @noExtraVitalsStored.
  ///
  /// In en, this message translates to:
  /// **'No extra vitals stored'**
  String get noExtraVitalsStored;
  ...
  /// No description provided for @noVolunteerRequests.
  ///
  /// In en, this message translates to:
  /// **'No volunteer requests.'**
  String get noVolunteerRequests;
  ...
  /// No description provided for @descriptionLabelShort.
  ///
  /// In en, this message translates to:
  /// **'Description'**
  String get descriptionLabelShort;
  ...
  /// No description provided for @userLabelShort.
  ///
  /// In en, this message translates to:
  /// **'User'**
  String get userLabelShort;

  /// No description provided for @helperLabelShort.
  ///
  /// In en, this message translates to:
  /// **'Helper'**
  String get helperLabelShort;
  ...
  /// No description provided for @newCaregiverRequest.
  ///
  /// In en, this message translates to:
  /// **'New Caregiver Request'**
  String get newCaregiverRequest;

  /// No description provided for @requestedDailyCare.
  ///
  /// In en, this message translates to:
  /// **'requested Daily care'**
  String get requestedDailyCare;
