                ...
                children: [
                    ...
                    onTap: () {
                      ...
                      if (user != null) {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                MedicationDashboardScreen(patientId: user.id),
                          ),
                        );
                      }
                    },
                        ...
                        onTap: () {
                          if (isSOSActive) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  "Emergency Request Active. Please wait.",
                                ),
                              ),
                            );
                          } else {
                  ...
                  _BigCard(
                    ...
                    onTap: () {
                      ...
                      if (user != null) {
                        ...
                        userData['uid'] =
                            user.id; // required by PatientDetailScreen map
                        userData['id'] = user.id;
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) =>
                                PatientDetailScreen(patientData: userData),
                          ),
                        );
                      }
                    },
                  ...
                  _BigCard(
                    ...
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const LiveQueueScreen(isStaff: false),
                      ),
                    ),
                  ),
                  _BigCard(
                    icon: Icons.handshake,
                    label: l10n.servicesHeader,
      ...
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            ...
            Expanded(child: Text(l10n.emergencyConfirmation)),
          ],
        ),
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              if (user != null) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(l10n.emergencyAlertSent),
                    backgroundColor: Colors.red,
                  ),
                );
  ...
  Widget build(BuildContext context) {
    ...
    VoidCallback? onTap = () {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(l10n.accessRequested)));
    };
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const HospitalAccessScreen()),
          );
        },
        borderRadius: BorderRadius.circular(16),
        child: Column(
                ...
                if (status == 'pending') ...[
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text(l10n.accessRequested)),
                      );
                    },
              ...
              bottom: TabBar(
                tabs: [
                  Tab(
                    ...
                    text: l10n.healthMonitor,
                  ),
                  Tab(icon: const Icon(Icons.assignment), text: l10n.serviceRequests),
                ],
              ),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return StreamBuilder<DocumentSnapshot>(
                          ...
                          builder: (context, userSnap) {
                            ...
                            final conditions =
                                data['conditions']?.isNotEmpty == true
                                ? data['conditions']
                                : l10n.noneReported;
                            final medicines =
                                data['medicines']?.isNotEmpty == true
                                ? data['medicines']
                                : l10n.noneReported;
                            final storedVitals =
                                data['storedVitals'] ??
                                data['vitals'] ??
                                l10n.noExtraVitalsStored;
                            ...
                            >(
                              ...
                              builder: (context, sosSnapshot) {
                                ...
                                if (sosSnapshot.hasData &&
                                    sosSnapshot.data!.docs.isNotEmpty) {
                                  if (sosSnapshot.data!.docs.first
                                          .data()['status'] ==
                                      'PENDING') {
                                    isEmergency = true;
                                  }
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            ...
                                            if (!isEmergency)
                                              ElevatedButton.icon(
                                                onPressed: () {
                                                  data['id'] = elderlyId;
                                                  final userObj = User.fromMap(
                                                    data,
                                                  );
                                                  _showCaregiverEmergencyConfirmation(
                                                    context,
                                                    userObj,
                                                  );
                                                },
                                        ...
                                        const SizedBox(height: 12),
                                        _buildDetailRow(l10n.fullName, name),
                                        _buildDetailRow(
                                          l10n.dob,
                                          data['dob'] ?? 'N/A',
                                        ),
                                        _buildDetailRow(l10n.age, age),
                                        _buildDetailRow(
                                          l10n.gender,
                                          data['gender'] ?? 'N/A',
                                        ),
                                        ...
                                        StreamBuilder<QuerySnapshot>(
                                          ...
                                          builder: (context, volSnap) {
                                            ...
                                            if (volSnap.data!.docs.isEmpty)
                                              return Text(
                                                l10n.noVolunteerRequests,
                                                style: const TextStyle(
                                                  color: Colors.grey,
                                                  fontSize: 12,
                                                ),
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemCount:
                                                  volSnap.data!.docs.length,
                                              itemBuilder: (context, index) {
                                                final volData =
                                                    volSnap.data!.docs[index]
                                                            .data()
                                                ...
                                                if (typeValue == 'Medicine pickup') type = l10n.medicinePickup;
                                                if (typeValue == 'Grocery Shopping') type = l10n.groceryShopping;
                                                if (typeValue == 'Daily errands') type = l10n.dailyErrands;
                                                if (typeValue == 'Daily care') type = l10n.dailyCare;
                                                ...
                                                if (statusValue == 'Pending') status = l10n.pending;
                                                if (statusValue == 'Approved') status = l10n.approved;
                                                if (statusValue == 'Accepted') status = l10n.volunteerAccepted;
                                                if (statusValue == 'Completed') status = l10n.complete;
                                                if (statusValue == 'Rejected') status = l10n.rejected;
                                                if (statusValue == 'On the Way') status = l10n.onTheWay;
      ...
      builder: (context) => AlertDialog(
        title: const Row(
          children: [
            ...
            SizedBox(width: 8),
            Text("Emergency for Patient"),
          ],
        ),
        content: Text(
          "Are you sure you want to raise an emergency alert for ${patient.name}?",
        ),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              SOSService().triggerSOS(
                role: 'caregiver',
                overrideUserId: patient.id,
              );
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text("Emergency Alert Sent for ${patient.name}!"),
                  backgroundColor: Colors.red,
                ),
              );
            },
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isPending =
                            p['hospitalAccessStatus'] == 'pending';
                        final isApproved =
                            p['hospitalAccessStatus'] == 'approved';
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) => PatientDetailScreen(
                                    patientData: p.cast<String, dynamic>(),
                                  ),
                                ),
                              );
                            },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const VolunteerTaskDashboard(),
                  ),
                );
              },
...
class _AppointmentStatusBoxState extends State<_AppointmentStatusBox> {
  ...
  String _getRejectionReasonText(String? value, AppLocalizations l10n) {
    ...
    switch (value) {
      case 'reasonDoctorUnavailable':
        return l10n.reasonDoctorUnavailable;
      case 'reasonSlotFull':
        return l10n.reasonSlotFull;
      case 'reasonIncompleteDetails':
        return l10n.reasonIncompleteDetails;
      case 'reasonReschedule':
        return l10n.reasonReschedule;
      case 'reasonEmergencyPriority':
        return l10n.reasonEmergencyPriority;
      case 'reasonOther':
        return l10n.reasonOther;
      default:
        return value; // Return custom text as is (or translate if needed? custom is usually custom)
    }
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<AppointmentModel>>(
      ...
      builder: (context, snapshot) {
        ...
        final serving = allAppointments
            .where((a) => a.status == AppointmentStatus.serving)
            .toList();
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      DoctorData.getDoctorName(current.doctorName, locale),
                      style: const TextStyle(fontWeight: FontWeight.bold),
                    ),
                    Text(
                      DoctorData.getDoctorDepartment(
                        current.department,
                        locale,
                      ),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        if (current.status == AppointmentStatus.serving)
                          ElevatedButton.icon(
                            onPressed: () => appointmentService.updateStatus(
                              current!.id,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "$doctorName - ${DoctorData.getDoctorDepartment(apt.department, locale)}",
                    ),
                    Text(
                      DateFormat('MMM dd').format(apt.appointmentDate),
...
class _SOSStatusBox extends StatefulWidget {
  ...
  const _SOSStatusBox({this.sosStream});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          ...
          .where(
            'status',
            whereIn: ['approved', 'serving', 'waiting'],
          ) // Only active states
          .snapshots(),
      builder: (context, snapshot) {
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty)
        ...
        final int? aptThreshold =
            myApt['alarmTokenDistance']; // Get saved preference
        final bool hasTriggered =
            myApt['alertTriggered'] ?? false; // Check persistence
        final bool isUpNextPersistent =
            myApt['isUpNext'] ?? false; // Explicit State
        ...
        return StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, queueSnap) {
            ...
            final threshold =
                aptThreshold ?? NotificationService().tokenAlertThreshold;

            // 4. Check Condition
            // Show if Persisted State is TRUE OR Calculation is Valid
            final bool conditionMet =
                diff <= threshold && currentToken < myToken + 1;
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            diff > 1
                                ? (locale == 'ml'
                                      ? "നിങ്ങളുടെ ഊഴം അടുത്തെത്തി! ($diff)"
                                      : "ALERT: YOU ARE $diff TOKENS AWAY!")
                          ...
                          Text(
                            locale == 'ml'
                                ? "ശബ്ദം നിർത്താൻ ഇവിടെ അമർത്തുക"
                                : "Tap here to stop alert",
                            style: GoogleFonts.outfit(
                              fontSize: 12,
