                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Card(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    _DetailRow(icon: Icons.cake, label: l10n.dateOfBirth, value: data['dob'] ?? data['dateOfBirth'] ?? 'Not provided', isEditable: false, onEdit: () => _editField(context, patientId, 'Date of Birth', 'dob', data['dob'] ?? data['dateOfBirth'] ?? 'Not provided', 'date')),
                                    const Divider(),
                                    _DetailRow(icon: Icons.calendar_month, label: l10n.age, value: _calculateAge(data['dob'] ?? data['dateOfBirth']), isEditable: false),
                                    const Divider(),
                                    _DetailRow(icon: Icons.person, label: l10n.gender, value: data['gender'] ?? 'Not provided', isEditable: false, onEdit: () => _editField(context, patientId, 'Gender', 'gender', data['gender'] ?? 'Not provided', 'gender')),
                                    const Divider(),
                                    _DetailRow(icon: Icons.phone, label: l10n.contactNumber, value: data['contactNumber'] ?? data['phone'] ?? 'Not provided', isEditable: false, onEdit: () => _editField(context, patientId, 'Contact Number', 'contactNumber', data['contactNumber'] ?? data['phone'] ?? 'Not provided', 'phone')),
                                    const Divider(),
                                    _DetailRow(icon: Icons.location_on, label: l10n.address, value: data['address'] ?? 'Not provided', isEditable: isStaff, onEdit: () => _editField(context, patientId, 'Address', 'address', data['address'] ?? 'Not provided', 'text')),
                                    const Divider(),
                                    _DetailRow(icon: Icons.emergency, label: l10n.emergencyContact, value: data['emergencyContact'] ?? 'Not provided', isEditable: isStaff, onEdit: () => _editField(context, patientId, 'Emergency Contact', 'emergencyContact', data['emergencyContact'] ?? 'Not provided', 'phone')),
                                  ],
                                ),
                              ),
                            )
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(l10n.medicalOverview, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.teal)),
                            const SizedBox(height: 12),
                            Card(
                              elevation: 2,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                   children: [
                                    _DetailRow(icon: Icons.bloodtype, label: l10n.bloodGroup, value: data['bloodGroup'] ?? 'Not provided', iconColor: Colors.red, isEditable: isStaff, onEdit: () => _editField(context, patientId, 'Blood Group', 'bloodGroup', data['bloodGroup'] ?? 'Not provided', 'bloodGroup')),
                                    const Divider(),
                                    _DetailRow(icon: Icons.medical_services, label: l10n.primaryCondition, value: data['conditions'] ?? 'None recorded', iconColor: Colors.blue, isEditable: isStaff, onEdit: () => _editField(context, patientId, 'Primary Condition', 'conditions', data['conditions'] ?? 'None recorded', 'text')),
                                    const Divider(),
                                    _DetailRow(icon: Icons.sick, label: l10n.chronicDiseases, value: data['chronicDiseases'] ?? 'None recorded', iconColor: Colors.purple, isEditable: isStaff, onEdit: () => _editField(context, patientId, 'Chronic Diseases', 'chronicDiseases', data['chronicDiseases'] ?? 'None recorded', 'text')),
                                    const Divider(),
                                    _DetailRow(icon: Icons.warning, label: l10n.knownAllergies, value: data['allergies'] ?? 'None recorded', iconColor: Colors.orange, isEditable: isStaff, onEdit: () => _editField(context, patientId, 'Known Allergies', 'allergies', data['allergies'] ?? 'None recorded', 'text')),
                                  ],
                                ),
                              ),
                            ),
                            const SizedBox(height: 24),
                            Text(l10n.doctorAppointments, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.teal)),
                            const SizedBox(height: 12),
                            _AppointmentsSection(patientId: patientId),
                            const SizedBox(height: 24),
                            Text(l10n.documentsReports, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.teal)),
                            const SizedBox(height: 12),
                            SizedBox(
                              width: double.infinity,
                              child: ElevatedButton.icon(
                                ...
                                label: Text(l10n.viewUploadMedicalRecords),
